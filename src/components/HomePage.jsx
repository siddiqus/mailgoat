      ...
      <div className="row justify-content-center">
        <div className="col-lg-8">
          <div className="text-center">
            ...
            <p className="lead text-muted mb-4 mt-2">
          ...
          <div className="row g-4 mt-4">
            <div className="col-md-4">
              <Link to="/templates" className="text-decoration-none">
                <Card className="hover-card text-center p-5">
                  <div className="mb-3">
                    <svg
                  ...
                  <p className="card-text text-muted mt-2">
                    Create and manage your email templates with dynamic parameters
                  </p>
                </Card>
              </Link>
            </div>
                ...
                <Card className="hover-card text-center p-5">
                  <div className="mb-3">
                    <svg
                      ...
                      height="64"
                      fill="currentColor"
                      className="bi bi-megaphone text-primary"
                      viewBox="0 0 16 16"
                    >
                  ...
                  <p className="card-text text-muted mt-2">
                    Organize and track your email campaigns for better analytics
                  </p>
                </Card>
              </Link>
            </div>
